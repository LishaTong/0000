...
experiment = Experiment(
  api_key="4RCwi9bWlik77BORaIAM7W8ZV",
  project_name="7773-2023hw4task2",
...
class TitanicFlow(FlowSpec):
    ...
    def train_model(self):
        ...
        experiment.log_model('model_%s' % self.num_trees, 'model_%s' % self.num_trees)
    ...
    def evaluate_model(self):
        ...
        experiment.log_metric('accuracy', self.accuracy)
